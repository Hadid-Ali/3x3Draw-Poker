...
public class DeepEvaluateDrawedDecks : MonoBehaviour
{
    public static string ComparePokerHands(Hand hand1, Hand hand2, out HandTypes player1, out HandTypes player2)
    {
        ...
        else
        {
            ...
            switch (rank1)
            {
                ...
                case HandTypes.HighCard:
                    ...
                    else
                    {
                        ...
                        for (int i = 0; i < hand1.CardData.Length; i++)
                        {
                            ...
                            else if (hand1.CardData[i].value < hand2.CardData[i].value)
                            {
                ...
                case HandTypes.TwoPair:
                    ...
                    else
                    {
                        ...
                        for (int i = 0; i < nonPairValues1.Count; i++)
                        {
                            ...
                            else if (nonPairValues1[i] < nonPairValues2[i])
                            {
                                return "Hand 2 wins";
                            }
                        }
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            for (int i = 0; i < nonThreeValues1.Count; i++)
                            {
                                ...
                                else if (nonThreeValues1[i] < nonThreeValues2[i])
                                {
                                    return "Hand 2 wins";
                                }
                            }
                ...
                case HandTypes.StraightFlush:
                    ...
                    else if (highestCardStraight1 < highestCardStraight2)
                    {
                        return "Hand 2 wins";
                    }
                    else
        ...
        CardValue GetPairOrThreeValue(Hand hand)
        {
            ...
            {
                if (kvp.Value == 2 || kvp.Value == 3) // Check for a pair or three of a kind
                {
                    return kvp.Key; // Return the value of the pair or three of a kind
                }
            }

            return CardValue.VALUE_2; // Default value if no pair or three of a kind is found
        }
        CardValue GetPairValue(Hand hand)
        {
            Dictionary<CardValue, int> valueCounts = new Dictionary<CardValue, int>();
            foreach (var card in hand.CardData)
            {
        ...
        List<CardValue> GetNonPairValues(Hand hand)
        {
        ...
        CardValue GetThreeOfAKindValue(Hand hand)
        {
            Dictionary<CardValue, int> valueCounts = new Dictionary<CardValue, int>();
            foreach (var card in hand.CardData)
            {
        ...
        CardValue GetHighestCardValue(Hand hand)
        {
